...
The system SHALL provide the React-islands + Tailwind v4 + SSG baseline: pinned deps, astro config with site/sitemap/react/tailwind/inlineStylesheets/PORT-aware server, `@/*` TS aliases with `react-jsx`, and static output.
