...
export function ContactForm() {
  ...
  return (
    <div id={SECTION_IDS.contactoFormulario} className="glass-panel-heavy relative w-full rounded-3xl p-10 transition-transform duration-500 md:p-14 rotate-[-1deg] hover:rotate-0 lg:rotate-[-2deg]">
